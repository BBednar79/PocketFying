public class CPEInstallationForm extends Form{
	private String date;
	private String name;
	 ...
	 * @param notes
	 */
	public CPEInstallationForm(String bandwidthReq, Contact poc, String date, String name, Technician technician,
			Technician technician2, Technician technician3, Technician technician4, Technician technician5,
			Technician technician6, Technician technician7, Technician technician8, boolean[] radioConfigChecklist,
			boolean[] installChecklist, String maximumCapacity, String notes) {
